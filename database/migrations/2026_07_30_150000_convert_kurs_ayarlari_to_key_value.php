...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('kurs_ayarlari') || ! Schema::hasColumn('kurs_ayarlari', 'sms_basvuru_onay')) {
            return;
        }

        $row = DB::table('kurs_ayarlari')->orderBy('id')->first();
        $veriler = [];
    ...
    public function down(): void
    {
        ...
        $harita = DB::table('kurs_ayarlari')->pluck('deger', 'anahtar')->all();
