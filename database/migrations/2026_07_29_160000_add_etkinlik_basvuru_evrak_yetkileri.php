...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $tanimlar = [
            'etkinlik_basvuru.evrak_goruntule' => ['etkinlik_basvuru.goruntule'],
            'etkinlik_basvuru.evrak_yukle' => ['etkinlik_basvuru.guncelle'],
            'etkinlik_basvuru.evrak_sil' => ['etkinlik_basvuru.guncelle'],
        ];

        foreach ($tanimlar as $kod => $kaynakKodlar) {
    ...
    public function down(): void
    {
        foreach ([
            ...
            'etkinlik_basvuru.evrak_yukle',
            'etkinlik_basvuru.evrak_sil',
        ] as $kod) {
