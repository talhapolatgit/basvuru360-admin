...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $tanimlar = [
            'etkinlik.yoklama_goruntule' => ['etkinlik.yoklama'],
            'etkinlik.mesaj_goruntule' => ['etkinlik.sms', 'etkinlik.eposta'],
        ];
    ...
    {
        foreach (['etkinlik.yoklama_goruntule', 'etkinlik.mesaj_goruntule'] as $kod) {
