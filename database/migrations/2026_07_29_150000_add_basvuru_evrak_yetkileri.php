...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $tanimlar = [
            'basvuru.evrak_goruntule' => ['basvuru.goruntule'],
            'basvuru.evrak_yukle' => ['basvuru.guncelle'],
            'basvuru.evrak_sil' => ['basvuru.guncelle'],
        ];
    ...
    {
        foreach (['basvuru.evrak_goruntule', 'basvuru.evrak_yukle', 'basvuru.evrak_sil'] as $kod) {
