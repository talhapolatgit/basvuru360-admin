...
use App\Models\KursAyar;
use App\Support\HtmlMetin;

class KursAyarServisi
{
    ...
    public function formVerisi(): array
    {
        ...
        return [
            ...
            'sms_metin_onay' => $this->metinVeyaVarsayilan($ayarlar['sms_metin_onay'] ?? null, KursAyar::DEFAULT_SMS_METIN_ONAY),
            'sms_metin_iptal' => $this->metinVeyaVarsayilan($ayarlar['sms_metin_iptal'] ?? null, KursAyar::DEFAULT_SMS_METIN_IPTAL),
            'sms_metin_yedek' => $this->metinVeyaVarsayilan($ayarlar['sms_metin_yedek'] ?? null, KursAyar::DEFAULT_SMS_METIN_YEDEK),
            ...
            'eposta_konu_onay' => $this->metinVeyaVarsayilan($ayarlar['eposta_konu_onay'] ?? null, KursAyar::DEFAULT_EPOSTA_KONU_ONAY),
            'eposta_konu_iptal' => $this->metinVeyaVarsayilan($ayarlar['eposta_konu_iptal'] ?? null, KursAyar::DEFAULT_EPOSTA_KONU_IPTAL),
            'eposta_konu_yedek' => $this->metinVeyaVarsayilan($ayarlar['eposta_konu_yedek'] ?? null, KursAyar::DEFAULT_EPOSTA_KONU_YEDEK),
            'eposta_metin_onay' => $this->metinVeyaVarsayilan($ayarlar['eposta_metin_onay'] ?? null, KursAyar::DEFAULT_EPOSTA_METIN_ONAY),
            'eposta_metin_iptal' => $this->metinVeyaVarsayilan($ayarlar['eposta_metin_iptal'] ?? null, KursAyar::DEFAULT_EPOSTA_METIN_IPTAL),
            'eposta_metin_yedek' => $this->metinVeyaVarsayilan($ayarlar['eposta_metin_yedek'] ?? null, KursAyar::DEFAULT_EPOSTA_METIN_YEDEK),
    ...
    {
        return $this->evetHayirDeger(KursAyar::harita(['onaylanmis_basvuru_kisi_iptal']), 'onaylanmis_basvuru_kisi_iptal') === 'evet';
    }

    /**
     * Portal başvuru formunda gösterilecek dolu onay metinleri.
     *
    ...
    public function basvuruOnaylari(): array
    {
        ...
        $kvkk = KursAyar::deger('kvkk_metni');
        if (! HtmlMetin::bosMu($kvkk)) {
            $sonuc[] = [
                'kod' => 'kvkk',
                'baslik' => HtmlMetin::baslik(KursAyar::deger('kvkk_baslik'), self::DEFAULT_KVKK_BASLIK),
                'metin' => (string) $kvkk,
            ];
        }

        $aydinlatma = KursAyar::deger('aydinlatma_metni');
        if (! HtmlMetin::bosMu($aydinlatma)) {
            $sonuc[] = [
                'kod' => 'aydinlatma',
                'baslik' => HtmlMetin::baslik(KursAyar::deger('aydinlatma_baslik'), self::DEFAULT_AYDINLATMA_BASLIK),
    ...
    {
        return KursAyar::secenek('sms_basvuru_onay');
    }

    public function smsBasvuruIptal(): SmsGonderimSecenegi
    {
        return KursAyar::secenek('sms_basvuru_iptal');
    }

    public function smsBasvuruYedek(): SmsGonderimSecenegi
    {
        return KursAyar::secenek('sms_basvuru_yedek');
    }

    public function smsMetinOnay(): string
    {
        return $this->metinVeyaVarsayilan(KursAyar::deger('sms_metin_onay'), KursAyar::DEFAULT_SMS_METIN_ONAY);
    }

    public function smsMetinIptal(): string
    {
        return $this->metinVeyaVarsayilan(KursAyar::deger('sms_metin_iptal'), KursAyar::DEFAULT_SMS_METIN_IPTAL);
    }

    public function smsMetinYedek(): string
    {
        return $this->metinVeyaVarsayilan(KursAyar::deger('sms_metin_yedek'), KursAyar::DEFAULT_SMS_METIN_YEDEK);
    }

    public function epostaBasvuruOnay(): SmsGonderimSecenegi
    {
        return KursAyar::secenek('eposta_basvuru_onay');
    }

    public function epostaBasvuruIptal(): SmsGonderimSecenegi
    {
        return KursAyar::secenek('eposta_basvuru_iptal');
    }

    public function epostaBasvuruYedek(): SmsGonderimSecenegi
    {
        return KursAyar::secenek('eposta_basvuru_yedek');
    }

    public function epostaKonuOnay(): string
    {
        return $this->metinVeyaVarsayilan(KursAyar::deger('eposta_konu_onay'), KursAyar::DEFAULT_EPOSTA_KONU_ONAY);
    }

    public function epostaKonuIptal(): string
    {
        return $this->metinVeyaVarsayilan(KursAyar::deger('eposta_konu_iptal'), KursAyar::DEFAULT_EPOSTA_KONU_IPTAL);
    }

    public function epostaKonuYedek(): string
    {
        return $this->metinVeyaVarsayilan(KursAyar::deger('eposta_konu_yedek'), KursAyar::DEFAULT_EPOSTA_KONU_YEDEK);
    }

    public function epostaMetinOnay(): string
    {
        return $this->metinVeyaVarsayilan(KursAyar::deger('eposta_metin_onay'), KursAyar::DEFAULT_EPOSTA_METIN_ONAY);
    }

    public function epostaMetinIptal(): string
    {
        return $this->metinVeyaVarsayilan(KursAyar::deger('eposta_metin_iptal'), KursAyar::DEFAULT_EPOSTA_METIN_IPTAL);
    }

    public function epostaMetinYedek(): string
    {
        return $this->metinVeyaVarsayilan(KursAyar::deger('eposta_metin_yedek'), KursAyar::DEFAULT_EPOSTA_METIN_YEDEK);
    }
