...
class KursAyar extends Model
{
    protected $table = 'kurs_ayarlari';

    public const DEFAULT_SMS_METIN_ONAY = 'Merhaba {ad_soyad}, kurs başvurunuz onaylanmıştır.';

    public const DEFAULT_SMS_METIN_IPTAL = 'Merhaba {ad_soyad}, kurs başvurunuz iptal edilmiştir.';

    public const DEFAULT_SMS_METIN_YEDEK = 'Merhaba {ad_soyad}, kurs başvurunuz yedek listeye alınmıştır.';

    public const DEFAULT_EPOSTA_KONU_ONAY = 'Kurs Başvuru Onayı';

    public const DEFAULT_EPOSTA_KONU_IPTAL = 'Kurs Başvuru İptali';

    public const DEFAULT_EPOSTA_KONU_YEDEK = 'Kurs Başvuru Yedek Bildirimi';

    public const DEFAULT_EPOSTA_METIN_ONAY = 'Merhaba {ad_soyad}, kurs başvurunuz onaylanmıştır.';

    public const DEFAULT_EPOSTA_METIN_IPTAL = 'Merhaba {ad_soyad}, kurs başvurunuz iptal edilmiştir.';

    public const DEFAULT_EPOSTA_METIN_YEDEK = 'Merhaba {ad_soyad}, kurs başvurunuz yedek listeye alınmıştır.';
