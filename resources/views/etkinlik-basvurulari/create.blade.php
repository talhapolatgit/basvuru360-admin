...
@section('title', 'Yeni Etkinlik Başvurusu')
...
<div class="page-header">
    <div class="page-header-text">
        ...
        <h1 class="page-title">Yeni Etkinlik Başvurusu</h1>
        <p class="page-subtitle">Önce etkinliği seçin, ardından katılımcı ve gerekirse veli bilgilerini girerek başvuruyu kaydedin.</p>
    </div>
    <div class="flex items-center gap-2">
        <x-back-button href="{{ route('etkinlik-basvurulari.index') }}">Başvurulara Dön</x-back-button>
    </div>
</div>
...
<form
    method="POST"
    action="{{ route('etkinlik-basvurulari.store') }}"
    enctype="multipart/form-data"
    class="basvuru-create"
    data-etkinlik-basvuru-create
    data-etkinlik-ozet-url-template="{{ url('/etkinlik-basvurulari/etkinlik/__ID__/ozet') }}"
...
>
    ...
    <nav class="basvuru-stepper" data-basvuru-stepper aria-label="Başvuru adımları">
        <button type="button" class="basvuru-step is-active" data-basvuru-step-btn="1">
            ...
            <span class="basvuru-step-label">Etkinlik</span>
        </button>
    ...
    <section class="card form-section-card basvuru-step-panel is-active" data-basvuru-step-panel="1">
        <div class="card-section-header">
            <div>
                <h2 class="card-section-title">Etkinlik Seçimi</h2>
                <p class="card-section-desc">Başvurunun yapılacağı etkinliği seçin. Hazırlık ve aktif etkinlikler listelenir.</p>
            </div>
        </div>

        <div class="form-group" style="max-width:520px;">
            <label>Etkinlik <span class="req">*</span></label>
            <x-searchable-select
                name="etkinlik_id"
                placeholder="Etkinlik seçin..."
                :value="old('etkinlik_id', $seciliEtkinlikId ?? '')"
                :options="$etkinlikOptions"
                :required="true"
                data-etkinlik-basvuru-select
            />
        </div>

        <div class="basvuru-kurs-ozet is-empty" data-etkinlik-basvuru-ozet>
            <p class="basvuru-kurs-ozet-empty">Etkinlik seçildiğinde özet bilgiler burada görünür.</p>
            <div class="basvuru-kurs-ozet-body" hidden data-etkinlik-basvuru-ozet-body>
                <div class="lesson-info-grid">
                    <div class="lesson-info-card">
                        <div class="lesson-info-label">Etkinlik No</div>
                        <div class="lesson-info-value" data-ozet="etkinlik_no">—</div>
                    </div>
                    <div class="lesson-info-card">
                        <div class="lesson-info-label">Ad</div>
                        <div class="lesson-info-value" data-ozet="ad">—</div>
                    </div>
                    <div class="lesson-info-card">
                        <div class="lesson-info-label">Tip</div>
                        <div class="lesson-info-value" data-ozet="tip">—</div>
                    </div>
                    <div class="lesson-info-card">
    ...
    <section class="card form-section-card basvuru-step-panel" data-basvuru-step-panel="4" hidden data-basvuru-evrak-panel>
        <div class="card-section-header">
            <div>
                ...
                <p class="card-section-desc">Bu etkinlik için zorunlu evrakları yükleyin. PDF veya JPG/PNG, en fazla 5 MB.</p>
            </div>
        </div>
    ...
    <div class="form-footer basvuru-create-footer">
        ...
        <div class="basvuru-create-footer-right">
            <x-back-button href="{{ route('etkinlik-basvurulari.index') }}">Vazgeç</x-back-button>
