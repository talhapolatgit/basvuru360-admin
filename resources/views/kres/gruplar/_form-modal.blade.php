<div class="confirm-modal" id="kres-grup-form-modal" hidden>
    ...
    <div class="confirm-modal-dialog confirm-modal-dialog--wide" role="dialog" aria-modal="true" aria-labelledby="kres-grup-form-modal-title">
        ...
        <form method="POST" action="{{ route('kres.gruplar.store') }}" class="kres-grup-form" data-create-url="{{ route('kres.gruplar.store') }}">
            ...
            <div class="confirm-modal-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="kres-grup-form-yedek-kontenjan">Yedek kontenjan</label>
                        <input type="number" id="kres-grup-form-yedek-kontenjan" name="yedek_kontenjan" class="form-control" data-field="yedekKontenjan" min="0" max="9999" value="0">
                    </div>
                </div>

                <div class="form-group">
                    <label for="kres-grup-form-cinsiyet">Cinsiyet</label>
                    <select id="kres-grup-form-cinsiyet" name="cinsiyet_sarti" class="form-control" data-field="cinsiyetSarti">
                        <option value="">Farketmez</option>
                        @foreach (\App\Enums\Cinsiyet::cases() as $cinsiyet)
                            <option value="{{ $cinsiyet->value }}">{{ $cinsiyet->label() }}</option>
                        @endforeach
                    </select>
                </div>
