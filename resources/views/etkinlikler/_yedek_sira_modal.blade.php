...
<div class="confirm-modal" id="etkinlik-yedek-sira-modal" hidden>
    <div class="confirm-modal-backdrop" data-yedek-sira-close></div>
    <div class="confirm-modal-dialog confirm-modal-dialog-lg" role="dialog" aria-modal="true" aria-labelledby="etkinlik-yedek-sira-modal-title">
        <div class="confirm-modal-header">
            <h3 id="etkinlik-yedek-sira-modal-title" class="confirm-modal-title">Yedek Sıra Güncelle</h3>
