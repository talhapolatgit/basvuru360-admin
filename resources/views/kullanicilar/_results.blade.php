        ...
        <tbody>
            @forelse ($kullanicilar as $kullanici)
                <tr>
                    ...
                    <td data-column="tc_kimlik_no">{{ $kullanici->tc_kimlik_no ?: '—' }}</td>
                    <td data-column="dogum_tarihi">{{ $kullanici->dogum_tarihi?->format('d.m.Y') ?? '—' }}</td>
                    <td data-column="telefon">{{ $kullanici->telefon ?: '—' }}</td>
                    ...
                    <td data-column="aktif_kurs_sayisi">{{ number_format($kullanici->aktif_kurs_sayisi) }}</td>
                    ...
                    <td data-column="olusturma">{{ $kullanici->created_at?->format('d.m.Y') }}</td>
                    <td data-column="islemler">
                        <div class="row-actions" data-row-actions>
                            ...
                            <div class="action-dropdown" data-action-dropdown hidden role="menu">
                                ...
                                <a href="{{ route('kullanicilar.edit', $kullanici) }}" class="action-dropdown-item" role="menuitem">
                                ...
                                @if ($kullanici->isOgretmen() || $kullanici->aktif_kurs_sayisi > 0)
                                    <a href="{{ route('takvim.index', ['ogretmen' => $kullanici->id]) }}" class="action-dropdown-item" role="menuitem">
                ...
                <tr>
                    <td colspan="{{ count($allColumns) }}">
                        <div class="empty-state">
                            ...
                            <div class="empty-state-title">Kullanıcı kaydı bulunamadı</div>
