...
<div class="page-header">
    <div class="page-header-text">
        ...
        <h1 class="page-title">Merkezler</h1>
        <p class="page-subtitle">Kursların düzenlendiği merkezleri listeleyin, oluşturun ve düzenleyin.</p>
    </div>
    <div class="flex items-center gap-2">
        <x-cta-button type="button" icon="plus" data-entity-modal-open>Yeni Merkez</x-cta-button>
    </div>
</div>
...
<div class="card filter-card">
    <div class="card-section-header">
        <div>
            ...
            <p class="card-section-desc">Merkez adına ve durumuna göre daraltın.</p>
        </div>
    </div>

    <form id="merkezler-filter-form" method="GET" action="{{ route('merkezler.index') }}">
        <div class="filter-grid">
            <div class="form-group">
                <label for="q">Merkez Adı</label>
                <div
                    class="input-with-mode"
                    data-search-mode
                    data-mode-param="q_mode"
                    data-mode-storage="merkez_ad_search_mode_v1"
                >
                    <input
                        type="text"
                        id="q"
        ...
        <div class="filter-actions">
            <div class="filter-actions-right">
                <x-back-button id="merkezler-filter-clear" type="button" icon="close">Temizle</x-back-button>
...
{{-- Tablo Kartı --}}
<div class="card table-card" id="merkezler-table-card">
    <div class="table-toolbar">
        <div>
            <div class="table-title">Merkez Kayıtları</div>
        ...
        <div class="flex items-center gap-2.5">
            ...
            <x-excel-export
                :href="route('merkezler.export', request()->query())"
                id="merkezler-excel-link"
            />
        </div>
    </div>

    <div id="merkezler-results">
        @include('merkezler._results')
    </div>
</div>
