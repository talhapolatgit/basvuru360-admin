                        ...
                        <div class="row-actions" data-row-actions>
                            ...
                            <div class="action-dropdown" data-action-dropdown hidden role="menu">
                                ...
                                <button
                                    ...
                                    role="menuitem"
                                    data-basvuru-durumlari-edit
                                    data-update-url="{{ route('sabit-tanimlar.basvuru-durumlari.update', $item) }}"
                                    data-kod="{{ $item->kod }}"
                                    data-ad="{{ $item->ad }}"
                ...
                <tr>
                    <td colspan="{{ count($allColumns) }}">
                        <div class="empty-state">
                            <div class="empty-state-title">Başvuru durumu bulunamadı</div>
