                        ...
                        <div class="row-actions" data-row-actions>
                            ...
                            <div class="action-dropdown" data-action-dropdown hidden role="menu">
                                ...
                                <button
                                    ...
                                    role="menuitem"
                                    data-etkinlik-tipleri-edit
                                    data-update-url="{{ route('sabit-tanimlar.etkinlik-tipleri.update', $item) }}"
                                    data-ad="{{ $item->ad }}"
                ...
                <tr>
                    <td colspan="{{ count($allColumns) }}">
                        <div class="empty-state">
                            <div class="empty-state-title">Etkinlik tipi bulunamadı</div>
