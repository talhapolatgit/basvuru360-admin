@php
    ...
    $sortableColumns = ['ad', 'olusturma'];
@endphp

<div class="table-wrapper">
    <table
        class="data-table"
        id="evrak-tipleri-table"
                        ...
                        <div class="row-actions" data-row-actions>
                            ...
                            <div class="action-dropdown" data-action-dropdown hidden role="menu">
                                ...
                                <button
                                    ...
                                    role="menuitem"
                                    data-evrak-tipleri-edit
                                    data-update-url="{{ route('sabit-tanimlar.evrak-tipleri.update', $item) }}"
                                    data-ad="{{ $item->ad }}"
                ...
                <tr>
                    <td colspan="{{ count($allColumns) }}">
                        <div class="empty-state">
                            <div class="empty-state-title">Evrak tipi bulunamadı</div>
