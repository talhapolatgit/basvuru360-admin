@php
    ...
    $sortableColumns = ['sira', 'ad'];
@endphp

<div class="table-wrapper">
    <table
        class="data-table"
        id="iptal-gerekceleri-table"
        ...
        <tbody>
            @forelse ($items as $item)
                <tr>
                    ...
                    <td data-column="aciklama">{{ $item->aciklama ?: '—' }}</td>
                        ...
                        <div class="row-actions" data-row-actions>
                            ...
                            <div class="action-dropdown" data-action-dropdown hidden role="menu">
                                ...
                                <button
                                    ...
                                    role="menuitem"
                                    data-iptal-gerekceleri-edit
                                    data-update-url="{{ route('sabit-tanimlar.iptal-gerekceleri.update', $item) }}"
                                    data-ad="{{ $item->ad }}"
                ...
                <tr>
                    <td colspan="{{ count($allColumns) }}">
                        <div class="empty-state">
                            <div class="empty-state-title">İptal gerekçesi bulunamadı</div>
