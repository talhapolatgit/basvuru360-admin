...
<div class="page-header">
    <div class="page-header-text">
        ...
        <h1 class="page-title">Eğitmenler</h1>
        <p class="page-subtitle">Eğitmenleri listeleyin, oluşturun ve düzenleyin.</p>
    </div>
    <div class="flex items-center gap-2">
        <x-cta-button :href="route('egitmenler.create')" icon="plus">Yeni Eğitmen</x-cta-button>
    </div>
</div>
...
<div class="card filter-card">
    <div class="card-section-header">
        <div>
            ...
            <p class="card-section-desc">Ad soyad, TC kimlik no, telefon, e-posta ve duruma göre daraltın.</p>
        </div>
    </div>

    <form id="egitmenler-filter-form" method="GET" action="{{ route('egitmenler.index') }}">
        <div class="filter-grid">
            <div class="form-group">
                ...
                <div
                    ...
                    data-mode-storage="egitmen_ad_soyad_search_mode_v1"
                >
                    <input
                        type="text"
                        id="ad_soyad"
        ...
        <div class="filter-actions">
            <div class="filter-actions-right">
                <x-back-button id="egitmenler-filter-clear" type="button" icon="close">Temizle</x-back-button>
...
{{-- Tablo Kartı --}}
<div class="card table-card" id="egitmenler-table-card">
    <div class="table-toolbar">
        <div>
            <div class="table-title">Eğitmen Kayıtları</div>
        ...
        <div class="flex items-center gap-2.5">
            ...
            <x-excel-export
                :href="route('egitmenler.export', request()->query())"
                id="egitmenler-excel-link"
            />
        </div>
    </div>

    <div id="egitmenler-results">
        @include('egitmenler._results')
    </div>
</div>
@endsection
